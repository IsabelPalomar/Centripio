...
Después de habilitar, si se desplaza hacia abajo se puede ver una serie de categorías de frases de habla pequeña comunes. Encuentre la sección "Hello / Goodbye" y haga clic en ella para expandirla. Agregue algunas respuestas diferentes a la pregunta "¿Cómo está?" Y luego haga clic en "Guardar" en la parte superior derecha. Al añadir frases, verá la cifra de porcentaje al lado de la sección "Hello / Goodbye" para mostrarle cuánto ha personalizado su chatbot.
